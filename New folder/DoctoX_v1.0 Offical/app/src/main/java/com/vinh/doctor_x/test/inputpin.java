package com.vinh.doctor_x.test;

/**
 * Created by Vinh on 05-Apr-18.
 */
...
public class inputpin extends EditText {
    ...
    public inputpin(Context context) {
        super(context);
    }

    public inputpin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public inputpin(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public inputpin(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
