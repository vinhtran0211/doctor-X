...
package com.vinh.doctor_x.Medical;
...
import com.vinh.doctor_x.Adapter.CustomMedicalProblemsAdapter;
...
public class MedicalProblems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Frg_main_patient.progressDialog!=null) Frg_main_patient.progressDialog.cancel();
    }
