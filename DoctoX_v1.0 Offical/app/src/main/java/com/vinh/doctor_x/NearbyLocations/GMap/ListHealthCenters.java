 ...
 *
 */
package com.vinh.doctor_x.NearbyLocations.GMap;
...
import com.vinh.doctor_x.Adapter.CustomPlacesAdapter;
import com.vinh.doctor_x.Fragment.Frg_main_patient;
import com.vinh.doctor_x.NearbyLocations.GeometryController;
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    Frg_main_patient.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
